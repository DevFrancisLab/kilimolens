...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "AI-powered climate-finance intelligence for agricultural lenders."
			},
			{
				name: "author",
				content: "KilimoLens"
...
var $$splitComponentImporter = () => import("./routes-DtPhP33w.js");
//#endregion
...
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "KilimoLens is an AI-powered climate-finance platform helping SACCOs, MFIs, banks and insurers turn fragmented agricultural and climate data into explainable lending risk insights."
		},
		{
			property: "og:title",
			content: "KilimoLens — Agricultural Risk Intelligence"
		},
		{
			property: "og:description",
			content: "Explainable AI for agricultural lending. Climate + satellite + farmer data, unified."
		},
		{
			property: "og:type",
			content: "website"
